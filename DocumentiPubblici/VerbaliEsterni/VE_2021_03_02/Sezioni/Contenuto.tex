...
\begin{itemize}
	...
	\item \textbf{VE\_\Data.5} Per lo unit testing verrà utilizzato il \glo{framework} \glo{mocha.js} attraverso il plugin che permette l'integrazione con la tecnologia \glo{serverless}.
\end{itemize}
