...
\begin{enumerate}
	\item Presentazioni;
	\item Motivazioni che hanno portato il gruppo {\Gruppo} alla scelta del \glo{capitolato} C2;
...
\begin{itemize}
	...
	\item L'interesse dei membri del gruppo verso le tecnologie che verranno impiegate per il compimento del progetto, in particolare l'architettura a \glo{microservizi} e i servizi offerti da \glo{AWS};
...
I proponenti hanno sottolineato fin da subito l'importanza di una \glo{efficace} comunicazione con il gruppo. Il loro tipico approccio è quello di tenersi in contatto con i gruppi in maniera costante sui vari canali \glo{Slack} e di organizzare quando necessario un meeting.
...
\begin{itemize}
  ...
  \item \textbf{VE\_\Data.2} Spiegate le motivazioni della scelta del \glo{capitolato} C2;
  ...
  \item \textbf{VE\_\Data.4} Vista la natura del progetto e le risorse che questo richiede, non sarà necessario pagare per usare i servizi offerti da \glo{AWS}.
\end{itemize}