...
\end{itemize}
\subsection{Services}
Ogni package presente all'interno del package services contiene il \glo{microservizio} che, invocando l'HTTPRequest, comunica con il \glo{back end}. Ogni servizio contiene funzioni publiche asincrone, per questo motivo il tipo di ritorno è una Promise.
\begin{figure}[H]
	\centering
