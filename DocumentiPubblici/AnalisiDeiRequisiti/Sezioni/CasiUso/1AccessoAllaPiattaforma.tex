\subsection{UC1 - Accesso alla piattaforma}\label{UC1}
...
\begin{itemize}
    ...
    \item \textbf{\glo{Precondizione}:} L'utente non è ancora autenticato presso il sistema.
    \item \textbf{\glo{Postcondizione}:} L'utente viene autenticato all'interno del sistema attraverso registrazione (UC1.1) o autenticazione (UC1.2).
...
\subsubsection{UC1.2 - Login}\label{UC1.2}
...
\subsection{UC2 - Logout dalla piattaforma}\label{UC2}
