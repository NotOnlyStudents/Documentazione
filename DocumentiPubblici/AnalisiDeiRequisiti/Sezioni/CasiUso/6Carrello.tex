...
\begin{itemize}
    ...
    \item \textbf{Scenario Principale:} L'utente clicca sull'azione per entrare nella vista del carrello all'interno del menù (UC3.4) e vede la lista dei prodotti che sono stati inseriti. Da qui potrà svolgere le seguenti operazioni:
    \begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Scenario Alternativo 1:} Se l'attore non è ancora autenticato, viene reindirizzato alla vista del login (UC1.2) o della registrazione per autenticarsi come acquirente, per poi procede al checkout.
...
L'acquirente procede al pagamento attraverso il servizio fornito da Stripe e poi gli viene mostrata una vista con il resoconto dell'ordine.
\begin{itemize}
