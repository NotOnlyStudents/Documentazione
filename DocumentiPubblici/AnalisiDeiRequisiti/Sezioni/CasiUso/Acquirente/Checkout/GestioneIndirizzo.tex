...
\begin{itemize}
    ...
    \begin{enumerate}[label=\lett]
        ...
        \begin{itemize}
            \item (UC52) - Viene mostrato il messaggio d'errore campo dati obbligatorio non inserito;
...
\begin{itemize}
    ...
    \begin{enumerate}[label=\lett]
        ...
        \begin{itemize}
            \item \hyperlink{CAlfabetici}{(UC44) - Viene mostrato il messaggio d'errore caratteri non alfabetici non permessi;}
...
\begin{itemize}
    ...
    \begin{enumerate}[label=\lett]
        ...
        \begin{itemize}
            \item (UC66) - Viene mostrato il messaggio d'errore CAP non valido;
            \item Verrà impedita l'aggiunta del nuovo indirizzo.
        \end{itemize}
    \end{enumerate}
\end{itemize}
