...
\label{filtro-temporale-ordine-acquirente}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item (UC\ref{filtro-temporale-ordine-acquirente.data-iniziale}) - Impostare la data iniziale dell'intervallo temporale;
        \item (UC\ref{filtro-temporale-ordine-acquirente.data-finale}) - Impostare la data finale dell'intervallo temporale.
    \end{itemize}
	\item \textbf{Scenari alternativi:}
	\begin{enumerate}[label=\lett]
...
\label{filtro-temporale-ordine-acquirente.data-iniziale}
...
\label{filtro-temporale-ordine-acquirente.data-finale}
