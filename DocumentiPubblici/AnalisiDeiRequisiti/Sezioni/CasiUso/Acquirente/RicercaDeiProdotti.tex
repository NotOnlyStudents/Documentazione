...
\begin{itemize}
    ...
    \item \textbf{Precondizione:} l'attore ha selezionato la funzionalità per la ricerca e l'inserimento delle parole per individuare un prodotto;
    ...
    \begin{enumerate}[label=\lett]
        \item L'attore ha svolto una ricerca in modo tale che questa non dia alcun risultato. In questo caso la PLP viene aggiornata mostrando nessun risultato trovato.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari alternativi:}
    \begin{enumerate}[label=\lett]
        \item L'attore ha impostato i filtri in modo tale che la ricerca con la loro combinazione non dia alcun risultato. In questo caso la PLP  viene aggiornata mostrando nessun risultato trovato.
    \end{enumerate}
\end{itemize}
