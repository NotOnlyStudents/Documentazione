...
L'utente non autenticato o l'acquirente può cercare i prodotti dalla schermata principale, oppure dalla \glo{PLP}, attraverso delle parole.
\begin{itemize}
...
\label{filtro-prodotti-acquirente.magazzino}
