...
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il venditore viene indirizzato nella schermata di amministrazione delle categorie e vede tutte le categorie presenti all'interno del sistema;
