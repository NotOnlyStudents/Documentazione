...
%\UC{Visualizzazione ordini cronologicamente}
...
\UC{Visualizzazione dettagli ordine}
...
\begin{itemize}
	...
	\begin{itemize}
		\item (\actualUC.1) - Impostazione del filtro per stato;
		\item (\actualUC.2) - Impostazione del filtro per intervallo temporale.
	\end{itemize}
...
\subUC{Filtro temporale per gli ordini ricevuti}
