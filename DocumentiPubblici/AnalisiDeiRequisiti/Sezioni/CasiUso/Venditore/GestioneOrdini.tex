...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\begin{enumerate}[label=\lett]
		\item Il venditore ha svolto una ricerca che non ha trovato coincidenze con nessun ordine. In questo caso la schermata di riepilogo ordini viene aggiornata mostrando nessun risultato trovato.
	\end{enumerate}
\end{itemize}
