\UC{Gestione dei prodotti}
Il venditore ha la possibilità di visualizzare l'elenco dei suoi prodotti inseriti all'interno della piattaforma e di gestirli secondo le proprie necessità.
\begin{itemize}
	...
	\item \textbf{Postcondizione:} il venditore viene indirizzato nella schermata di amministrazione dei prodotti e vede tutti i propri prodotti inseriti all'interno del sistema;
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore rimuove le foto relative al prodotto attraverso i seguenti passi: %il venditore rimuove delle foto relative al prodotto selezionato;
    \begin{itemize}
...
\UC{Rimozione prodotto}
Il venditore vuole rimuovere un prodotto inserito precedentemente all'interno della piattaforma.
\begin{itemize}
	\item \textbf{Attori primari:} venditore;
	\item \textbf{Precondizione:} il venditore si trova nella schermata di amministrazione dei prodotti;
