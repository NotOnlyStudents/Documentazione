...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}[label=\lett]
		\item L'utente inserisce un nome che presenta dei caratteri non alfabetici. In questo caso:
        \begin{itemize}
...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}[label=\lett]
		\item L'utente inserisce un cognome che presenta dei caratteri non alfabetici. In questo caso:
        \begin{itemize}
            \item (UC) - Verrà visualizzato il messaggio di errore caratteri non alfabetici non permessi;
...
\begin{itemize}
	...
	\item \textbf{Estensioni:}
	\begin{enumerate}[label=\lett]
		\item L'utente inserisce un indirizzo email e l'identity manager segnala che l'indirizzo email non è presente nella piattaforma, in questo caso:
		\begin{itemize}
