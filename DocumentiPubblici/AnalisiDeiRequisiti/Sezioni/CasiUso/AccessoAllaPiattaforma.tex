...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\end{itemize}
		%\item l'utente prova ad accedere alla piattaforma con i dati inseriti nel modulo senza aver confermato il proprio indirizzo email
		%\begin{itemize}
		%	\item (UC) - Visualizzazione messaggio di errore in caso di credenziali sconosciute;
		%	\item L'utente non possiede un account presso il sistema.
		%\end{itemize}
	\end{enumerate}
\end{itemize}
