...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item (\actualUC.1) - Inserimento dati per la registrazione;
	...
	\begin{enumerate}[label=\lett]
		...
		\begin{itemize}
			...
			\item (UC45) - Visualizzazione messaggio di errore in caso di registrazione con un'e-mail già utilizzata nella piattaforma;
...
\begin{itemize}
    ...
    \begin{itemize}
    	...
    	\item (\actualUC.1) - Inserimento dati per l'autenticazione;% Inserisce le credenziali per accedere alla piattaforma
	...
	\begin{enumerate}[label=\lett]
		...
		\begin{itemize}
			...
			\item (UC48) - Viene visualizzato un messaggio di errore credenziali non presenti nella piattaforma;
...
\begin{itemize}
	...
	\begin{itemize}
		\item L'utente accede al sistema;
		\item L'utente non autenticato si trova nella schermata di login;
		\item (UC2.1) - Inserimento dati per l'autenticazione;% Inserisce le credenziali per accedere alla piattaforma
		\item L'utente richiede l'autenticazione;
...
\begin{itemize}
    ...
    \begin{itemize}
        \item (\actualUC.1) - Inserimento indirizzo e-mail per cambio password;
	...
	\begin{enumerate}[label=\lett]
		...
		\begin{itemize}
			\item (UC47) - Viene visualizzato un messaggio di errore indirizzo e-mail non registrato nella piattaforma;
...
\begin{itemize}
	...
	\begin{enumerate}[label=\lett]
		...
		\begin{itemize}
			...
			\item Viene fornita all'utente la possibilità di modificare l'indirizzo e-mail inserito.
		\end{itemize}
		\item L'utente non autenticato non ha inserito un'e-mail che è registrata nella piattaforma. In questo caso:
		\begin{itemize}
			\item (UC47) - Viene visualizzato il messaggio di errore e-mail non registrata.
			\item Non verrà inviata alcuna e-email per il cambio della password.
		\end{itemize}
	\end{enumerate}
\end{itemize}
