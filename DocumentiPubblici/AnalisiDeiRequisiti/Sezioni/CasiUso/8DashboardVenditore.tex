...
\begin{itemize}
    ...
    \item \textbf{Precondizione:} Il venditore si trova nella vista della \glo{dashboard} e seleziona l'azione per aggiungere un prodotto.
...
\subUC{Aggiunta o rimozione prodotto nella sezione dei prodotti in evidenza}
