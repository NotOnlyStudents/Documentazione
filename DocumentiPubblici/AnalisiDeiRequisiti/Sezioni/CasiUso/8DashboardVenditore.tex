...
\begin{itemize}
    ...
    \item \textbf{Scenario Principale:} Il venditore preme sull'azione che porta alla pagina di modifica di un prodotto e compie zero, o più, delle seguenti azioni:
    \begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Scenario Alternativo:} Il venditore ha rimosso tutte le categorie di quel prodotto e per questo viene automaticamente categorizzato come senza categoria.
\end{itemize}
...
\subUC{Aggiunta di nuove foto del prodotto}
...
\subUC{Rimozione delle foto del prodotto}
