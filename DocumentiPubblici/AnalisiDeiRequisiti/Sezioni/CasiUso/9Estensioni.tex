...
\begin{itemize}
    ...
    \item \textbf{Postcondizione:} Al venditore viene impedita l'operazione e viene segnalata la causa.
    \item \textbf{Scenario Principale:} Visualizzazione messaggio di errore il quale segnala al venditore l'obblogatorietà di inserimento di almeno una foto relativa al prodotto e blocca l'operazione che stava eseguendo.
\end{itemize}
