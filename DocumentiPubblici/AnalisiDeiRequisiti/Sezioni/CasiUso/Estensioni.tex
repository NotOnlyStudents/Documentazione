...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore inserisce un file di tipo non immagine e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore inserisce un prezzo minore o uguale a zero e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore inserisce una quantità del prodotto minore o uguale a zero e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore inserisce uno sconto minore di zero e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore inserisce uno sconto maggiore di 100\% e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore cerca di aggiungere una nuova foto relativa ad un prodotto, anche quando si è già raggiunto il limite massimo di quattro e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore non inserisce alcuna foto relativa ad un prodotto e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore vuole assegnare ad una categoria un nome già utilizzato da un'altra categoria e viene informato di ciò.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attori primari:} venditore;
    \item \textbf{Precondizione:} il venditore sta cercando di eliminare un prodotto che risulta ordinato in un ordine che non è stato ancora evaso;
    \item \textbf{Postcondizione:} al venditore viene mostrato un messaggio il quale lo informa che il prodotto che sta cercando di eliminare risulta ordinato in un ordine che non è stato ancora evaso.
    \item \textbf{Scenario principale:} il venditore sta cercando di eliminare un prodotto che risulta ordinato in un ordine che non è stato ancora evaso e viene informato di ciò.
\end{itemize}
