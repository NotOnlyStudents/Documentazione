...
\customlabel{estensione:caratteri-non-alfabetici}{\actualUC}
...
\customlabel{estensione:registrazione-con-email-esistente}{\actualUC}
...
<<<<<<< HEAD
\customlabel{estensione:cambio-con-email-esistente}{\actualUC}
...
>>>>>>> feature/correzioniGenerali_03_03
\begin{itemize}
...
\customlabel{estensione:email-non-esistente}{\actualUC}
...
\customlabel{estensione:credenziali-non-presenti}{\actualUC}
...
\customlabel{estensione:email-non-valida}{\actualUC}
...
\customlabel{estensione:password-non-valida}{\actualUC}
...
\customlabel{estensione:password-conferma-diverse}{\actualUC}
...
\customlabel{estensione:campo-obbligatorio-non-inserito}{\actualUC}
...
\customlabel{estensione:data-non-valida}{\actualUC}
...
\customlabel{estensione:codice-ordine-non-valido}{\actualUC}
...
\customlabel{estensione:data-iniziale-maggiore-data-finale}{\actualUC}
...
\customlabel{estensione:quantita-non-valida}{\actualUC}
...
\customlabel{estensione:numero-eccessivo-caratteri}{\actualUC}
...
\customlabel{estensione:file-no-tipo-immagine}{\actualUC}
...
\customlabel{estensione:prezzo-minore-o-uguale-zero}{\actualUC}
...
\customlabel{estensione:quantita-minore-a-zero}{\actualUC}
...
\customlabel{estensione:sconto-minore-zero}{\actualUC}
...
\customlabel{estensione:sconto-maggiore-cento}{\actualUC}
...
\customlabel{estensione:limite-foto-raggiunto}{\actualUC}
...
\customlabel{estensione:nessuna-foto-inserita}{\actualUC}
...
\customlabel{estensione:categoria-esistente}{\actualUC}
...
\customlabel{estensione:cap-non-valido}{\actualUC}
...
\customlabel{estensione:pagamento-fallito}{\actualUC}
