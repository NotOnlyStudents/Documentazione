...
\hypertarget{CAlfabetici}{\UC{Visualizzazione messaggio di errore caratteri non alfabetici non permessi}}
...
% Estensioni e-mail
\hypertarget{RegistrazioneEmailPresente}{\UC{Visualizzazione messaggio di errore in caso di registrazione con un'e-mail già utilizzata nella piattaforma}}
...
\hypertarget{CambioEmailPresente}{\UC{Visualizzazione messaggio di errore in caso di cambio e-mail con una già utilizzata nella piattaforma}}
...
\hypertarget{EmailNonRegistrata}{\UC{Visualizzazione messaggio di errore in caso di e-mail non registrata}}
...
\hypertarget{CredenzialiNonPresenti}{\UC{Visualizzazione messaggio di errore in caso di credenziali non presenti nella piattaforma}}
...
\hypertarget{EmailInvalida}{\UC{Visualizzazione messaggio di errore in caso di e-mail non valida}}
...
% Estensioni password
\hypertarget{PasswordInvalida}{\UC{Visualizzazione messaggio di errore password non rispetta i requisiti di complessità}}
...
\hypertarget{PasswordsDiverse}{\UC{Visualizzazione messaggio di errore in caso di password e password di conferma diverse}}
...
\hypertarget{CampoObbligatorio}{\UC{Visualizzazione messaggio di errore campo dati obbligatorio non inserito}}
Visualizzazione messaggio di errore che segnala all'utente il mancato riempimento di un campo dati obbligatorio.
\begin{itemize}
    \item \textbf{Attori primari:} utente autenticato o utente non autenticato;
...
% Estensioni ordini
\hypertarget{DataInvalida}{\UC{Visualizzazione messaggio d'errore data non valida}}
...
\hypertarget{CodiceInvalido}{\UC{Visualizzazione messaggio d'errore codice dell'ordine non valido}}
...
\hypertarget{DateErrate}{\UC{Visualizzazione messaggio d'errore data iniziale maggiore di quella finale}}
...
% Estensioni PDP
\hypertarget{QuantitàAggiuntaInvalida}{\UC{Visualizzazione messaggio d'errore quantità da aggiungere al carrello non valida}}
...
\hypertarget{TroppiCaratteri}{\UC{Visualizzazione messaggio di errore in caso di inserimento di un numero eccessivo di caratteri}}
...
\hypertarget{NoImmagine}{\UC{Visualizzazione messaggio di errore nel caso in cui il file selezionato non sia del tipo immagine}}
...
% Estensioni prodotto
\hypertarget{PrezzoErrato}{\UC{Visualizzazione messaggio di errore in caso di prezzo minore o uguale a zero}}
...
\hypertarget{QuantitàErrata}{\UC{Visualizzazione messaggio di errore in caso di quantità minore a zero}}
