...
\rfun{O}{\ref{autenticazione-piattaforma}} & L'utente non autenticato che dispone di credenziali venditore può accedere alla piattaforma usando l'e-mail e la password & UC\ref{autenticazione-piattaforma} \\

\rfun{O}{\ref{autenticazione-piattaforma}} & L'utente non autenticato che dispone di credenziali acquirente può accedere nella piattaforma usando l'e-mail e la password & UC\ref{autenticazione-piattaforma} \\
