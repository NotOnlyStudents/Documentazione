...
\rfun{O}{\ref{autenticazione-piattaforma}} & L'utente non autenticato che dispone di credenziali può accedere alla piattaforma usando l'e-mail e la password. & UC\ref{autenticazione-piattaforma} \\
