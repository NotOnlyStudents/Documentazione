...
\rfun{O}{\ref{modifica-informazioni-venditore.password}} & Il venditore può modificare la password con la quale si autenticherà. & UC\ref{modifica-informazioni-venditore.password} \\
