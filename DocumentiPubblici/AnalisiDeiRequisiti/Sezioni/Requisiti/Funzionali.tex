...
\begin{longtable}{c C{9.5cm} C{2.5cm}} 
    ...
    \input{DocumentiPubblici/AnalisiDeiRequisiti/Sezioni/Requisiti/Funzionali/RequisitiVenditore/RequisitiGestioneAccountVenditore}
    
    \input{DocumentiPubblici/AnalisiDeiRequisiti/Sezioni/Requisiti/Funzionali/RequisitiVenditore/RequisitiProdotto}
    
    \input{DocumentiPubblici/AnalisiDeiRequisiti/Sezioni/Requisiti/Funzionali/RequisitiVenditore/RequisitiRicercaDeiProdottiVenditore}
    
    \input{DocumentiPubblici/AnalisiDeiRequisiti/Sezioni/Requisiti/Funzionali/RequisitiVenditore/RequisitiCategoria}
    
    \input{DocumentiPubblici/AnalisiDeiRequisiti/Sezioni/Requisiti/Funzionali/RequisitiVenditore/RequisitiOrdine}
