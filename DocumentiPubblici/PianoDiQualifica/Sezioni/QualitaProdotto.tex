...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			\rowcolor{darkblue}
			\multicolumn{2}{|c|}{\textcolor{white}{\textbf{MPDS03: Tempo di caricamento delle viste}}}\\ \hline
			Descrizione & Consiste nella velocità con cui le varie viste del prodotto software vengono caricate e mostrate all'utente ed è riportato nelle \NdPv{1.0.0} alla sezione \S{D2.2}.\\ \hline
