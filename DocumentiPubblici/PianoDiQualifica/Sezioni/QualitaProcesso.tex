...
Il gruppo {\Gruppo} ha deciso di adottare lo standard \glo{SO/IEC 15504}, conosciuto anche con il termine \glo{\textit{SPICE}}, combinato con il miglioramento continuo. Queste scelte sono state prese per garantire lo sviluppo di un prodotto di \glo{qualità} entro i costi ed i tempi stabiliti nel \textit{\PdP}. \\
Lo standard ISO/IEC 15504 assicura la qualità di tutti i \glo{processi} che compongono lo sviluppo del \glo{prodotto} finale tramite una definizione chiara degli obiettivi di processo e delle soglie da rispettare. Per garantire invece il principio di miglioramento continuo nella qualità di processo, si è deciso di utilizzare il \glo{ciclo di Deming}, noto anche come \glo{\textit{PDCA}}. \\
Per una descrizione più dettagliata dello standard ISO/IEC 15504 e del \textit{PDCA} si rimanda rispettivamente alle appendici \S{A} e \S{B} presenti nelle \textit{\NdPv{1.0.0}}.
...
\begin{itemize}
	...
	I risultati di un'attività di pianificazione di \glo{qualità} sono:
	\begin{itemize}
...
\begin{itemize}
	...
	L'obiettivo dell'\AdR{} è di trasformare i requisiti dati dallo \glo{stakeholder} in requisiti tecnici che indirizzino il \glo{team} allo sviluppo del prodotto software.
	\item \textbf{Esiti del processo} \\
