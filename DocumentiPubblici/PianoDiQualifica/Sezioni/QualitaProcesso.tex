...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & La metrica che individua i requisiti obbligatori soddisfatti è definita nelle \NdPv{1.0.0} alla sezione \S{2.3.4.9}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di Gulpease è definito nelle \NdPv{1.0.0} alla sezione \S{3.2.10}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di correttezza ortografica è definito nelle \NdPv{1.0.0} alla sezione \S{3.2.10}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di varianza del costo al completamento del progetto è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice della somma delle spese sostenute dal gruppo è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & Il costo sostenuto per il lavoro svolto è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
			Risultato & Numero con virgola calcolato ad intervalli regolari.\\ \hline
			Valore ottimale & Corrispondente al preventivo.\\ \hline
			Valore minimale & Corrispondente al preventivo.\\ \hline
		\end{tabular}
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice del costo corrispondente alla spesa pianificata per il progetto è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
			Risultato & Numero con virgola calcolato ad intervalli regolari.\\ \hline
			Valore ottimale & Corrispondente al preventivo.\\ \hline
			Valore minimale & Corrispondente al preventivo.\\ \hline
		\end{tabular}
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di varianza rispetto allo schedule è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di varianza dei costi è definito nelle \NdPv{1.0.0} alla sezione \S{4.2.4.7}.\\ \hline
...
\begin{table} [H]
	\begin{center}
		\begin{tabular}{|c| p{12cm}|}
			...
			Descrizione & L'indice di velocità di risoluzione dei problemi è definito nelle \NdPv{1.0.0} alla sezione \S{4.4.5}.\\ \hline
