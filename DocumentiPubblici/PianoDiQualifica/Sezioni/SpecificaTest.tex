...
\label{specificatest}
Il gruppo ha deciso di utilizzare il \glo{Modello} a V, come modello di sviluppo del software per assicurare la \glo{qualità} del \glo{prodotto}.
Il modello a V illustra le relazioni tra ogni \glo{fase} del ciclo di vita di sviluppo e la fase di testing ad essa associata.
...
\begin{longtable}{|c| C{10cm} |C{3cm}|} 
	...
	TRFO1 & Viene verificato che l'utente possa \glo{registrarsi} ed eseguire l'accesso con e-mail e password & Non ancora in sviluppo \\ \hline
	...
	TRFO5 & Viene verificato che l'\glo{acquirente} abbia un menù da cui accedere facilmente alla pagina personale, home, carrello e da cui riesca ad eseguire il logout & Non ancora in sviluppo \\ \hline
    ...
    TRFO15 & Viene verificato che l'utente non autenticato debba autenticarsi prima di procedere con il \glo{checkout} & Non ancora in sviluppo \\ \hline
	...
	TRFO17 & Viene verificato che l'acquirente o il \glo{venditore} possa visualizzare i prodotti contenuti in un ordine, le loro quantità, l'indirizzo di spedizione e il prezzo totale di pagamento & Non ancora in sviluppo \\ \hline
    ...
    TRFO27 & Viene verificato che l'\glo{amministratore} possa aggiungere ed eliminare account di venditori & Non ancora in sviluppo \\ \hline
...
Lo scopo dei test di unità è quello di isolare ciascuna parte di un programma e mostrarne correttezza e completezza nell’\glo{implementazione}, facendo emergere eventuali difetti, in modo che essi possano essere corretti prima dell’integrazione.
...
Servono a controllare che il software creato soddisfi i requisiti concordati e le esigenze del \glo{proponente}. I test di accettazione vengono eseguiti assieme al proponente prima del rilascio del software, dopo aver testato l’intero sistema e dopo la correzione dei difetti riscontrati.
