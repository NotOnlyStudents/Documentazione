...
Durante il periodo di progettazione di dettaglio, come nel periodo precedente, i documenti redatti da presentare in ingresso alla \glo{RQ} sono stati sottoposti a verifica secondo i criteri definiti nelle \NdPv{3.0}. In questo periodo sono stati valutati attraverso verifica anche i vari processi istanziati.
%\subsubsection{Esiti verifica}
%\myparagraph{Documentazione}
%Di seguito si riportano gli esiti delle metriche relative alla documentazione.
