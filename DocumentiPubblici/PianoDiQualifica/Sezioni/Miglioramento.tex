...
\myparagraph{Progettista}
\begin{itemize}
	\item \textbf{Problema:} i membri del team incaricati all'individuazione del \glo{design pattern} architetturale hanno riscontrato diverse difficoltà e dubbi nel trovare quello più adatto per lo sviluppo del progetto.\\
