...
\DefinizioneGlossario{
	È un \glo{processo} che ha l'obiettivo di rilevare la presenza di difetti, eseguendo una lettura mirata dell'oggetto di verifica.
}
...
\DefinizioneGlossario{
	Funzionalità messa a disposizione da \glo{GitHub} con cui si intende una qualsiasi idea, miglioramento, compito o errore su cui lavorare. È possibile assegnare issue a più membri del gruppo di lavoro ed etichettarle per cercarle più rapidamente.
}
