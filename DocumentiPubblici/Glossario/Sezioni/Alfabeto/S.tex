...
\TermineGlossario{Slack, tempo di}
\DefinizioneGlossario{
...
\DefinizioneGlossario{
	Indica un'astrazione software progettata per utilizzare delle API \glo{standard} e condivise per la trasmissione e la ricezione di dati attraverso una rete oppure come meccanismo di IPC.
}
...
\DefinizioneGlossario{
	\glo{Fase} iniziale che consiste nel creare le diverse componenti scrivendo codice. Queste poi verranno testate e assemblate per comporre il \glo{prodotto}.
}
