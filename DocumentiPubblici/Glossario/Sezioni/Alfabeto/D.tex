...
\DefinizioneGlossario{
	Libreria \glo{\textit{JavaScript}} per la creazione di grafici per la visualizzazione dinamica dei dati. 
}
...
\DefinizioneGlossario{
	Soluzione progettuale generale ad un problema ricorrente. É la descrizione di un modello da applicare per risolvere un problema, il quale può presentarsi in diverse situazioni durante la progettazione e lo sviluppo del software.
}
