...
\DefinizioneGlossario{
	Si rimanda alla voce \glo{\hyperlink{designPattern}{Design Pattern}} del {\Glossario}.
}
...
\DefinizioneGlossario{
	\glo{Baseline} del prodotto successiva alla \glo{\textbf{Technology Baseline}} in cui viene mostrato il design definitivo del prodotto finale e illustra l'architettura del progetto.
}
