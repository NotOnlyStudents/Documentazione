...
\TermineGlossario{Mocha.js}
\DefinizioneGlossario{
	Mocha è un framework per Node.js per l'implementazione di test asincroni, rapporti sulla copertura dei tests e utilizzo di qualsiasi libreria di asserzioni.
}
...
\DefinizioneGlossario{
	Acronimo di Model-View-Controller, si tratta di un pattern architetturale. \\ Molto diffuso nello sviluppo di sistemi software, è in grado di separare la logica di presentazione dei dati dalla logica di business.
}
