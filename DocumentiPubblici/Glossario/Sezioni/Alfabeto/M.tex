...
\TermineGlossario{MQTT}
\DefinizioneGlossario{
	 Protocollo ISO \glo{standard} (ISO/IEC PRF 20922) di messaggistica posizionato in cima a \textit{TCP/IP}. È stato progettato per le situazioni in cui è richiesto un basso impatto e dove la banda è limitata. 
}
...
\DefinizioneGlossario{ 
	Il Model-view-controller è un pattern architetturale molto diffuso nello sviluppo di sistemi software, in grado di separare la logica di presentazione dei dati dalla logica di business.
}