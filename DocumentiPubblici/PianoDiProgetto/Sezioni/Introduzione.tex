...
Il progetto {\tolerance= 3000\relax
\NomeProgetto .\par} ha come scopo quello di rendere disponibile un servizio e-commerce sfruttando però tutti i vantaggi di un'architettura Serverless:
\begin{itemize}
...
\subsection{Ruoli e Costi}%Da rivedere perchè si ripete troppe volte la parola ruolo e non so se effettivamente serva come sezione
