...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\subsubsection{Ripianificazione attuata durante il periodo} \label{RipianificazionePArch}
In seguito alla \glo{RR}, ai colloqui con il \VT e il \CR e ai valori ottenuti dal calcolo delle metriche riportate nel \PdQv{2.0}, il gruppo è stato costretto a rivedere più volte la pianificazione delle attività per poter recuperare i ritardi dovuti a correzioni non previste da riportare principalmente all'\AdR\. 
