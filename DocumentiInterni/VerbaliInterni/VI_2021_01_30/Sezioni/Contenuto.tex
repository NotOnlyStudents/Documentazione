...
\begin{itemize}
	...
	\item \textbf{Problemi inclusioni analisi dei requisiti}: É necessario confrontarsi con il \CR per la modifica delle inclusioni presenti nei vari \glo{diagrammi UML};
