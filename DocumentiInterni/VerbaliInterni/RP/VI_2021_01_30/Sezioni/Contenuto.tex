...
\begin{enumerate}
 \item Discussione sulle soluzioni agli errori emersi dalla valutazione \glo{\textbf{RR}};
 \item Aggiornare la schedulazione delle \glo{attività} fino alla \glo{\textbf{RP}};
 \item Cambiare piattaforma di comunicazione.
\end{enumerate}

\section{Resoconto}
\subsection{Discussione sulle soluzioni agli errori emersi dalla valutazione \glo{RR}}
...
\begin{itemize}
	...
	\item \textbf{Problemi inclusioni \AdR}: è necessario confrontarsi con il \CR\ per la modifica delle inclusioni presenti nei vari \glo{diagrammi UML};
...
\end{itemize}
\subsection{Aggiornare la schedulazione delle attività fino alla \glo{RP}}
...
\begin{itemize}
  ...
  \item \textbf{VI\_\Data.2} \MM\ e \TL\ si occupano di aggiornare la schedulazione per prepararsi all'ingresso in \glo{\textbf{RP}};
