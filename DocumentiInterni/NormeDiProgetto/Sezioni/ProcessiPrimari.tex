...
\begin{itemize}
	...
	\item \textbf{\textit{\Glossario}:} contiene termini utilizzati da gruppo nella documentazione che posso creare ambiguità.
\end{itemize}
Alla documentazione è allegata la \textit{Lettera di Presentazione} con cui i membri del gruppo \Gruppo\ formalizzano il loro impegno nel portare a termine il capitolato prescelto rispettato i requisiti minimi richiesti e la data di consegna.\\
