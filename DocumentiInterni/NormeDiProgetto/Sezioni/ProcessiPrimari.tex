...
Come indicato dallo \glo{standard} ISO/IEC 12207:1995 il processo di fornitura è costituito dalle \glo{attività} svolte dal fornitore al fine di comprendere e soddisfare le richieste del proponente.\\
Il processo di fornitura è costituito dalle seguenti attività:
\begin{itemize}
	\item \textbf{Avvio:} il gruppo analizza i \glo{capitolati} proposti e redige lo \SdF{};	
...
\begin{itemize}
	...
	\item Norme per la redazione \glo{efficace} dello \SdF{}.
\end{itemize}
...
\subsubsection{Materiale fornito}\label{MaterialeFornito} 
...
\begin{itemize}
	...
	\item \textbf{Piano di qualifica:} contiene gli obiettivi quantitativi di \glo{qualità} fissati, l'analisi degli scostamenti e le misure correttive adottate;
...
\begin{itemize}
	...
	\item \textbf{Microsoft Excel:} utilizzato per la realizzazione dei diagrammi all'interno del documento \PdPv{2.0}.
\end{itemize}
\newpage
...
\begin{itemize}
	\item \textbf{Lucidhart:} utilizzato per la realizzazione dei \glo{diagrammi UML} all'interno del documento \AdRv{2.0}.
\end{itemize}
\newpage