...
\begin{itemize}
	...
	\item \textbf{Allegato tecnico:} documento di supporto alla \glo{PB} che descrive approfonditamente l'architettura del sistema.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Microsoft Excel:} utilizzato per la realizzazione dei diagrammi all'interno del documento \PdPv{3.0}.
\end{itemize}
\newpage
