...
\myparagraph{Metriche}\label{MCodifica}
...
\item\textbf{MPDS06: Facilità di comprensione} \hypertarget{MFComprensione}\\
...
\item\textbf{MPDS07: Semplicità delle funzioni}\hypertarget{MSFunzioni}\\
Il valore stabilisce la semplicità di un metodo basandosi sul numero di parametri a lui necessari.

\item\textbf{MPDS08: Semplicità delle classi}\hypertarget{MSClassi}\\
