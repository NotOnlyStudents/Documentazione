...
\myparagraph{Metriche}\label{MProgettazione}Di seguito vengono presentate le metriche utilizzate per garantire il controllo sulla qualità. Per una descrizione sullo standard di riferimento e un elenco completo di tutte le metriche applicate si rimanda a \S\ref{9126} dell'appendice. 
\begin{itemize}
