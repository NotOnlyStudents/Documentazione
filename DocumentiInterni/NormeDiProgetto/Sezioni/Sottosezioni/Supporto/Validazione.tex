...
\begin{itemize}
	...
	\item Rilegge il codice e calcola l'\glo{\textit{indice di Gulpease}};
	\item Se riscontra problemi, avverte il redattore del documento e il verificatore. L'issue torna in "TO DO" in attesa delle modifiche. Quando queste vengono apportate si torna al secondo punto;
