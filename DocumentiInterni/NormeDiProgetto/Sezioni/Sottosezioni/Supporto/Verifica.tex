...
\begin{itemize}
	...
	\item \glo{\textbf{Inspection:}} procede ad una lettura critica di una parte prodotto in esame, focalizzando la ricerca su problemi che si presentano più frequentemente indicati nella lista di controllo all'interno del \PdQ.
\end{itemize}
...
\begin{itemize}
	\item Se non ancora creata, crea l'\glo{issue} in GitHub;
