...
L'analisi dinamica procede a verificare il programma durante la sua esecuzione. Per procedere a questa attività vengono utilizzati \glo{GitHub} Actions e dei \glo{test} ripetibili e automatizzati con specifici:
\begin{itemize}
