...
Il gruppo si aspetta da questo processo di conseguire la qualità del prodotto prevista secondo le aspettative del proponente attraverso un'azione preventiva. Il documento \PdQv{2.0} individua quanto stabilito indicando gli obiettivi di qualità da raggiungere e le \glo{metriche} da utilizzare per la valutazione della qualità.
...
\subsubsection{Svolgimento di un processo}\label{QualitàProcesso}Durante lo svolgimento di un processo, le attività vengono svolte perseguendo il raggiungimento degli obiettivi individuati all'interno del \PdQv{2.0} e le seguenti caratteristiche di qualità di prodotto:
\begin{itemize}
...
Gli obiettivi di qualità presenti nel \PdQv{2.0} vengono classificati secondo il seguente formato:
\begin{center}
...
Le metriche utilizzate per la valutazione della qualità presenti nel \PdQv{2.0}\ vengono classificate secondo il seguente formato:
\begin{center}
