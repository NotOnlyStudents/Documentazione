...
\subsubsection{Svolgimento di un processo}\label{QualitàProcesso}Durante lo svolgimento di un processo, le attività vengono svolte perseguendo il raggiungimento degli obiettivi individuati all'interno del \PdQv{1.0.0} e le seguenti caratteristiche di qualità di prodotto:
\begin{itemize}
