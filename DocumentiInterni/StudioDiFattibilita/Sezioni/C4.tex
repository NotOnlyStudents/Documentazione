...
La parte server, di supporto alla presentazione nel browser e utile all'esecuzione delle query ad un database \glo{SQL} o \glo{NoSQL}, potr\'a essere sviluppata in \glo{Java} con \glo{Tomcat} o in Javascript con \glo{Node.js}.
...
\begin{itemize}
	...
	\item Tratta un ambito moderno ed affascinante come lo studio dei \glo{BigData}.
\end{itemize}
