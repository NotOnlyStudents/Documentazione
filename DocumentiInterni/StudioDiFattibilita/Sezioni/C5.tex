...
Il \glo{capitolato} richiede lo sviluppo di un sistema \glo{real-time} in grado di gestire più entità caratterizzate da un punto di partenza, una velocità di crociera ed una lista di punti di interesse da raggiungere.
...
\begin{itemize}
	\item Motore real-time: si pensava di usare \glo{Java}, per la facilità di gestione degli oggetti e dei \glo{thread};
