...
La piattaforma consisterà in una \glo{web application} che dovrà essere composta dalle seguenti viste:
\begin{itemize}
	\item Home page;
...
\subsection{Vincoli}
Il progetto deve operare in 3 ambienti: \glo{locale}, \glo{testing} e \glo{staging}. L'ambiente di staging deve essere accessibile pubblicamente.
